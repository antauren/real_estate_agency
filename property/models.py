...
class Flat(models.Model):
    ...
    owner_phone_pure = PhoneNumberField("Нормализованный номер владельца", max_length=20, null=True, blank=True)
    ...
    likers = models.ManyToManyField(User, null=True, blank=True, related_name='flats', verbose_name="Кому понравилось")
